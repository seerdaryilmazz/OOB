...
public class CountryRepositoryIntegrationTest {
    ...
    public void cleanup() {
        TestUtils.softDeleteAll(countryRepository);
    }
    ...
    public void saveMustWorkCorrectly() {
        ...
        Assert.assertNotNull("'save' does not work correctly.", country);
        Assert.assertNotNull("'save' does not work correctly.", country.getId());
    }
}