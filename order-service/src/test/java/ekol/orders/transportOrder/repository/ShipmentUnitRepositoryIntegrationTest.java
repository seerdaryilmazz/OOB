...
public class ShipmentUnitRepositoryIntegrationTest {
    ...
    public void saveMustWorkCorrectly() {
        ...
        ShipmentUnit persistedEntity = shipmentUnitRepository.save(SomeData.someShipmentUnit(persistedShipment, persistedPackageType).build());
