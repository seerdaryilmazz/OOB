...
public class EquipmentRequirementRepositoryIntegrationTest {
    ...
    public void saveMustWorkCorrectly() {
        ...
        EquipmentRequirement persistedEntity = equipmentRequirementRepository.save(SomeData.someEquipmentRequirement(persistedTransportOrder, persistedEquipmentType).build());
