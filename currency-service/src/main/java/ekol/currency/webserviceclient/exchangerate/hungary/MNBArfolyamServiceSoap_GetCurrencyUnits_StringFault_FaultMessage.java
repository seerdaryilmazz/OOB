...
public class MNBArfolyamServiceSoap_GetCurrencyUnits_StringFault_FaultMessage
    extends Exception {
    private static final long serialVersionUID = 1510434709109L;
    ...
    public MNBArfolyamServiceSoap_GetCurrencyUnits_StringFault_FaultMessage() {
        super(
            "MNBArfolyamServiceSoap_GetCurrencyUnits_StringFault_FaultMessage");
    }
