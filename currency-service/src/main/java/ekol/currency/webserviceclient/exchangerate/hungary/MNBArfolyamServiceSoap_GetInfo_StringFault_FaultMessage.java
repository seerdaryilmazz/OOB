...
public class MNBArfolyamServiceSoap_GetInfo_StringFault_FaultMessage extends Exception {
    private static final long serialVersionUID = 1510434709094L;
    ...
    public MNBArfolyamServiceSoap_GetInfo_StringFault_FaultMessage() {
        super("MNBArfolyamServiceSoap_GetInfo_StringFault_FaultMessage");
    }
