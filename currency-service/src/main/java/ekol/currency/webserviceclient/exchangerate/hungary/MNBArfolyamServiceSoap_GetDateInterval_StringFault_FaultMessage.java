...
public class MNBArfolyamServiceSoap_GetDateInterval_StringFault_FaultMessage
    extends Exception {
    private static final long serialVersionUID = 1510434709113L;
    ...
    public MNBArfolyamServiceSoap_GetDateInterval_StringFault_FaultMessage() {
        super("MNBArfolyamServiceSoap_GetDateInterval_StringFault_FaultMessage");
    }
